...
RSpec.describe HttpLoader do
  ...
  it 'requires feed url to present' do
    feed.url = nil
    expect { subject.call(feed) }.to raise_error(HTTP::Error)
  end
